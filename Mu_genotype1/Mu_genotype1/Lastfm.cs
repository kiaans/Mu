...
namespace Mu_genotype1
{
    static class Lastfm
    {
        ...
        public static async Task<string> user_getRecommendedArtists() 
        {
            ...
            {
                HttpClient cli = new HttpClient();
                string reco_sig = "api_key" + Globalv.lfm_api_key + "limit14methoduser.getRecommendedArtistssk" + Globalv.session_key + "0e6e780c3cfa3faedf0c58d5aa6de92f";
                ...
                string get_reco_artists = @"http://ws.audioscrobbler.com/2.0/?method=user.getRecommendedArtists&limit=14&api_key=" + Globalv.lfm_api_key + @"&api_sig=" + reco_sig +"&sk=" + Globalv.session_key;
        ...
        {
            HttpClient cli = new HttpClient();
            string get_top_tracks = @"http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&api_key=" + Globalv.lfm_api_key + @"&page=1&limit=15";
